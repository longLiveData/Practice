...
# 从对应玩家的手牌列表中随机选择一个并返回
def comp10001go_play(discard_history, player_no, hand):
    return random.choice(hand)

# print(comp10001go_play([[], [], []], 1, ['QC', 'AC', '5H']))

# 取discard_history列表中每个小列表的第player_no个元素
# 组成一个新列表并返回
...
# print(comp10001go_group([['0S','KH','AC','3C'], ['JH','AD','QS','5H'], ['9C','8S','QH','9S']], 3))
...
# print(comp10001go_score_group(['2C']))
# print(comp10001go_score_group(['2C', '2S']))
# print(comp10001go_score_group(['4C', '4H', '4S']))
# print(comp10001go_score_group(['4C', '4H', '3S']))
# print(comp10001go_score_group(['4C', '4H', 'AS']))

# print(comp10001go_score_group(['KC', 'KH', 'KS', 'KH']))

# print(comp10001go_score_group(['3C', '4H', 'AS', '6H', '7S']))

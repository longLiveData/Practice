...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		if ("user".equals(otherArgs[0].toLowerCase())) {
			param = TrendingParameter.USER;

		} else if ("tweet".equals(otherArgs[0].toLowerCase())) {
			param = TrendingParameter.TWEET;

		} else if ("hashtag".equals(otherArgs[0].toLowerCase())) {
			param = TrendingParameter.HASHTAG;

		} else if ("hashtag_pair".equals(otherArgs[0].toLowerCase())) {

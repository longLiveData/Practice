...
public class TestSeqCounter {
	public static void main(String[] args) throws Exception {
		...
		job.addCacheFile(new URI("/home/wsh/seq4.txt"));
		...
		FileInputFormat.addInputPath(job, new Path("/home/wsh/dna-short.txt"));

		// Output path is second argument when program called
		FileOutputFormat.setOutputPath(job, new Path("/home/wsh/sampleResults.txt"));

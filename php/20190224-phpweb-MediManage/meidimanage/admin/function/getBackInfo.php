...
$query_sql = "select * from leaveInfo where info_state = '3' and info_stu_class = '{$adminClass}';";
...
if($num == 0){
    ...
    $infoBackComtime = $row[9];
    $infoLeaveVeritime = $row[10];
    $infoNums = $num ;
    ...
    $resStr = array("code"=>$vCode, "infoId"=>$infoId, "infoStuId"=>$infoStuId, "infoStuClass"=>$infoStuClass,
        ...
        "infoBackComtime"=>$infoBackComtime, "infoLeaveVeritime"=>$infoLeaveVeritime);
}
